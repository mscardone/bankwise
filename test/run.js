...
(function () {
  ...
  ok("items that belong to a minigame or D&D go with those, supplies stay supplies", K.kindOf("Bailing bucket", ["Minigame items"]) === "minigame" && tab("Bailing bucket", ["Minigame items"]) === 6 && tab("Bailing bucket", []) !== 6 && K.kindOf("Air rune", ["Minigame items"]) === "runes" && K.kindOf("Decorative sword", ["Castle Wars"]) === "minigame" &&
    K.minigameIn("A bailing bucket is used to bail water out of the boat during the Fishing Trawler minigame.") === "Fishing Trawler" && K.minigameIn("The abyssal whip is a one-handed melee weapon.") === "" && K.tabFor("minigame", "five", "Bailing bucket").number === 5);
  (function () { var D3 = require("../src/data.js"); ok("pages about quests in general are not quests: Quests, List of quests, Quest points, guides", ["Quests", "Quest", "Miniquests", "List of quests", "Quest points", "Quest experience rewards", "Nature Spirit/Quick guide", "Free-to-play quests"].every(function (t) { return !D3._isQuestTitle(t); }) && ["Nature Spirit", "While Guthix Sleeps", "The Feud", "Quiet Before the Swarm", "One Piercing Note"].every(D3._isQuestTitle)); })();
